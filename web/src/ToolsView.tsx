...
const TOOL_CARDS: Array<{ id: ToolId; icon: string; title: string; description: string; badge: string }> = [
  ...
  { id: "palette", icon: "◌", title: "Factory Palette", description: "Explore and label 28 device-generated colors.", badge: "BLE" },
  { id: "latency", icon: "↯", title: "Latency Lab", description: "Measure transport, perception, and light response.", badge: "Camera + mic" },
  { id: "blink", icon: "◎", title: "Blink Lab", description: "Measure blink rates and calibrate firmware speed.", badge: "Camera" },
...
export function ToolsView({ active, activeTool, setActiveTool, controller, setController, manualControlSignal, notify }: {
  ...
  return (
    <div className="page tools-page">
      ...
      <div hidden={activeTool !== "palette"}><FactoryPaletteTool controller={controller} setController={setController} notify={notify} /></div>
      ...
      <div hidden={activeTool !== "blink"}><BlinkLabTool active={active && activeTool === "blink"} controller={controller} setController={setController} notify={notify} /></div>
